...
<body background="/index.jpg">
    ...
    <div style="margin: 0 auto;width: 500px;text-align: center;">
        <h1 style="margin-top: 200px"><font color="red">预约体育馆注册中心</font></h1>
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button type="submit" class="layui-btn layui-btn-checked" lay-type="" onclick="register()">注册</button>

                <button type="submit" class="layui-btn" lay-submit="" lay-filter="demo1" onclick="login()">我有账号，去登陆</button>
    <#--
